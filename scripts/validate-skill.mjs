...
if (!installPolicy.includes('operation === "launchers"') || !installPolicy.includes("SUSTECH_BIN") || !installPolicy.includes("sustech-advisor.cmd") || !installPolicy.includes("setlocal DisableDelayedExpansion")) throw new Error("Installation policy does not generate sibling-bound cross-platform launchers with stable batch expansion.");
