...
Never split or copy a multi-person score onto individual profiles. Keep student-provided preferences as `personal` evidence, clearly separated from NCES. When exact evidence is absent, say so; do not substitute overall rating, difficulty, or workload for grading.
