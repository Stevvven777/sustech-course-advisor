...
- For lecture/lab courses, normalize all required components into one `CourseSection` before recommendation. Credits appear once; meetings and the complete teaching team include every required component.
