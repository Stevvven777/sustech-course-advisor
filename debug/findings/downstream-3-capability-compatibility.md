...
- Bootstrap invariant: both platform scripts verify exact registry availability before installation and require the newly installed command pair to report `installationReady: true`; a missing credential remains a separate authentication state.
